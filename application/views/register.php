            ...
            <div class="col">
                <div id="loginModal" class="modal">
                    <div class="modal-content">
                        <span class="close" style="text-align: start;"><a href="<?php echo base_url() . '/login/userlogin' ?>"><i class="fa-solid fa-angle-left" style="color: #000;"></i></a></span>
                        <!-- <a href="<?php echo base_url() . '/' ?>"><img src="<?php echo base_url() . '/assets/ta-logo.png' ?>" alt="logo" class="logo"></a> -->

                        <h3 class="heading">Sign up to explore the best Travel'Avail</h3>
                        ...
                        <form class="row g-3 needs-validation" id="registerForm" method="post" novalidate>
                            <div class='form-group'>
                                <div class='row'>
                                    <div class='col'>
                                        <label for="validationCustomUsername" style="font-weight: 600;">First Name</label>
                                        <input type='text' class='form-control' id="validationCustom03" name='first_name' placeholder='First name' style='padding: 20px 9%; border: 2px solid #eee; border-radius: 6px;' required>
                                        <div class="invalid-feedback">
                                            Please provide a valid city.
                                        </div>
                                    </div>
                                    <div class='col'>
                                        <label for="floatingInput" style="font-weight: 600;">Last Name</label>
                                        <input type='text' class='form-control' id='floatingInput' name='last_name' placeholder='Last name' style='padding: 20px 9%; border: 2px solid #eee; border-radius: 6px;' required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="floatingInput" style="font-weight: 600;">Email address</label>
                                <input type="email" class="form-control" id="floatingInput" name="email" placeholder="Email" style="padding: 20px 4%; border: 2px solid #eee; border-radius: 6px;" required>
                            </div>
                            <div class="form-group">
                                <label for="floatingPassword" style="font-weight: 600;">Create a Password</label>
                                <input type="password" class="form-control" id="floatingPassword" name="password" placeholder="Password" style="padding: 20px 4%; border: 2px solid #eee; border-radius: 6px;" required>
                            </div>
                            <div class="form-group" style="display: flex; align-items: center; flex-direction: column; margin: 16px;">
                                <input class="btn btn-primary" type="submit" name="submit" value="Sign Up" style="width: 100%; border-radius: 12px;">
                                <p style="text-align: center; border-top: 2px solid #eee; font-weight: 500; padding-top: 14px; margin-top: 14px; margin-bottom: 0;"><a href="<?php echo base_url() . 'login/userlogin' ?>" style="font-weight: 600; color: var(--blue);">Sign In</a> using your Travel'Avail account</p>
                            </div>
                            <?php echo form_close(); ?>
                        </form>
