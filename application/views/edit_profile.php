    ...
    <section>
            ...
            <div id="editprofileModal" class="modal">
                <div class="modal-content" style="height: 84vh; overflow-y: auto;">
                    ...
                    foreach ($myprofile as $key => $value) {
                        ...
                        echo "<input type='text' class='form-control' id='userId' name='userId' value='$value->id' style='padding: 20px 6%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo "</div>";
                        echo "</fieldset>";
                        echo "<div class='form-group'>";
                        ...
                        echo   "<input type='text' class='form-control' id='first_name' name='first_name' value='$value->first_name' placeholder='First name' style='padding: 20px 12%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo "</div>";
                        echo  "<div class='col'>";
                        echo   "<label for='last_name' style='font-weight: 500;'>Last Name:</label>";
                        echo       "<input type='text' class='form-control' id='last_name' name='last_name' value='$value->last_name' placeholder='Last name' style='padding: 20px 12%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo    "</div>";
                        echo "</div>";
                        echo "</div>";
                        echo "<div class='form-group'>";
                        echo "<label for='username' style='font-weight: 500;'>Email Address:</label>";
                        echo  "<input class='form-control' type='email' id='email' name='email' value='$value->email' placeholder='Email' style='padding: 20px 6%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo "</div>";
                        ...
                        if ($this->session->userdata('userinfo')['role'] == 'Admin') {
                            ...
                            echo "<select class='form-select form-select-sm' name='role' style='padding: 10px 5%; width: 100%; border: 2px solid #eee; border-radius: 6px; color: #495057;'>";
                            if ($value->role == 'User') {
                        ...
                        echo   "<input class='form-control' type='password' id='password' name='password' value='$value->password' placeholder='Password' style='padding: 20px 6%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo "</div>";
                        echo "<div class='form-group'>";
                        echo   "<label for='address' style='font-weight: 500;'>Address:</label>";
                        echo   "<textarea class='form-control' type='text' id='address' name='address' value='' placeholder='Address' style='padding: 14px 6%; border: 2px solid #eee; border-radius: 6px;'>$value->address</textarea>";
                        echo "</div>";
                        echo "<fieldset disabled>";
                        echo "<div class='form-group'>";
                        echo "<label for='created_date' style='font-weight: 500; margin-right: 6px'>Created Date:</label>";
                        echo "<input class='form-control' type='date' id='' name='created_date' value='$value->created_date' style='padding: 20px 6%; border: 2px solid #eee; border-radius: 6px;'>";
                        echo "</div>";
                        echo "</fieldset>";
                        echo "<div class='button' style='text-align: end; padding-top: 14px;'>";
                        echo "<input class='btn btn-dark' type='submit' name='submit' value='Save' style='border-radius: 10px'>";
                        echo "</div>";
                        echo "</form>";
                        echo "</div>";
                        echo form_close();
        ...
        <div class="data" style="display: flex; min-height: 50vh; padding: 10px 0;">
            ...
            foreach ($myprofile as $key => $value) {
                ...
                echo   "<input type='text' class='form-control' id='first_name' name='first_name' value='$value->first_name' placeholder='First name' style='padding: 20px 8%; border: 2px solid #eee; border-radius: 6px;'>";
                echo "</div>";
                echo   "<div class='col'>";
                ...
                echo  "<input class='form-control' type='email' id='email' name='email' value='$value->email' placeholder='Email Address' style='padding: 20px 4%; border: 2px solid #eee; border-radius: 6px;'>";
                echo "</div>";
                echo "<div class='form-group'>";
